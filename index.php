        ...
        <div class="col-sm-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
          <form action="<?PHP $_SERVER['PHP_SELF'] ?>#contact" method="POST" enctype="multipart/form-data">
            ...
            <div class="alert alert-info mt-1 d-none" role="alert">
              We are sending your message now. Please don't refresh or close this page. If you have attached multiple or large files then this could take a few minutes...
              <div class="sk-circle">
